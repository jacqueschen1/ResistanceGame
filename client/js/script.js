...
const assign = document.getElementById('startgame');
...
socket.on('merlinPage', function(data) {
	document.getElementById('role').innerHTML='Hi ' +
	data.p_name + ', you are merlin';
	document.getElementById('others').innerHTML='The bad guys are: '
	+ data.badGuys.join(', ');
...
socket.on('goodguyPage', function(data) {
	document.getElementById('role').innerHTML='Hi ' +
	data.p_name + ', you are a good guy';
...
socket.on('yourTurn', function(data) {
	document.getElementById('pick').innerHTML= data.player +
